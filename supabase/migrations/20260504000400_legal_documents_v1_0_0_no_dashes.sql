-- =============================================================================
-- KEYRA Migration 032: legal_documents v1.0.0 sem travessões
--
-- Decisão editorial 2026-05-04: KEYRA evita travessões em corpo de texto.
-- Substituídos en-dash (U+2013) e em-dash (U+2014) por espaço único, com
-- colapso de whitespace residual. Versão semântica permanece 1.0.0; a
-- alteração é cosmética, não muda obrigações nem direitos. §11 dos Termos
-- prevê: "Mudanças cosméticas (correção tipográfica, link quebrado) não
-- geram nova versão major".
--
-- O componente apps/web/src/components/keyra/LegalDocument.tsx mantém a
-- sanitização runtime como guard (defesa em camadas), evitando qualquer
-- regressão visual caso conteúdo futuro contenha travessões acidentais.
--
-- Diagnóstico:
--   terms   v1.0.0: 9 em-dashes removidos, novo content_hash recalculado
--   privacy v1.0.0: 12 em-dashes removidos, novo content_hash recalculado
-- =============================================================================
...
$LEGAL$,
  content_hash = '3e8a61e1ed1a0f677a345a43b8aad1c75f7c87d410607146e739185c50d7fc2e'
WHERE type = 'terms' AND version = '1.0.0';
...
$LEGAL$,
  content_hash = '5b581a4d587f6a2ad9ee62a953f90933da78d7ba80c2551cd666986c8f51576d'
WHERE type = 'privacy' AND version = '1.0.0';
